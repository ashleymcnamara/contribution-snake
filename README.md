...
| **Your graph** | A real user's last 12 months, 52×7. Brighter days are worth more, clearing a whole week (column) scores a multiplier-scaled bonus, and the pace ramps up as you clear the board. Eat the whole year to win. | — (scores aren't comparable) |
