...
Along the way there are golden commits for bonus points, achievements to unlock, and server-verified leaderboards that stay available from home and appear with ranked results. Progress keeps lifetime stats, achievements, and your best replay together. Daily results become a labeled, spoiler-free scorecard; a verified share link gets a personalized preview and opens the same board with that run as the featured ghost. Daily streaks, completed objectives, and campaign clears unlock snake skins, grid themes, and trails in the Locker. Click any standing to watch the run back, or export it as a video clip to share. Endless Classic also has optional unranked customization for wrap-around walls, chill speed, rotten commits, and racing your own best ghost.
